...
/* temporarily used for R OS, Time to run e2fsck full scan */
#define CORE_FILE_CHECKED 0x100
	if (sb->s_snapshot_r_blocks_count != (API_LEVEL_ROS | CORE_FILE_CHECKED)) {
		...
		sb->s_snapshot_r_blocks_count = API_LEVEL_ROS | CORE_FILE_CHECKED;
